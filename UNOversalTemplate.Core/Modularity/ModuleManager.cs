...
namespace UNOversal.Modularity
{
    ...
    public class ModuleManager : IModuleManager
    {
        ...
        public void LoadModule(string moduleName)
        {
            ...
            {
                throw new ModuleNotFoundException(moduleName, string.Format(CultureInfo.CurrentCulture, "Module {0} was not found in the catalog.", moduleName));
            }
            else if (modules.Count() > 1)
            {
                throw new DuplicateModuleException(moduleName, string.Format(CultureInfo.CurrentCulture, "A duplicated module with name {0} has been found in the ModuleCatalog.", moduleName));
            }
