...
//https://github.com/CommunityToolkit/WindowsCommunityToolkit/blob/c8f76d072df53d3622fb5440d63afb06cb9e7a10/Microsoft.Toolkit.Uwp/Helpers/SystemInformation.cs
...
namespace UNOversal.Helpers
{
    ...
    public sealed class SystemInformationHelper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInformationHelper"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the unique instance of <see cref="SystemInformationHelper"/>.
        /// </summary>

/* Unmerged change from project 'Project2FA.UWP'
Before:
        public static SystemInformation Instance { get; } = new SystemInformation();
After:
        public static SystemInformationHelper Instance { get; } = new SystemInformation();
*/
        ...
        /// before using <see cref="SystemInformationHelper"/> or if the app is not updated.
        /// </summary>
        ...
        {
            if (args.PreviousExecutionState is ApplicationExecutionState.ClosedByUser || args.PreviousExecutionState is ApplicationExecutionState.NotRunning)
            {
